...
#define MAX_GIMBAL_PITCH_CONTROL_SIGNAL_AMPLITUDE 20000		// defined in range [0,+30000]
...
#define MAX_REV_CONTROL_SIGNAL_AMPLITUDE 4000
#define MAX_REV_INTEGRATIVE_CONTROL_PART_AMPLITUDE 0.03f	// this value was chosen by looking at the integral error that is reached in 1s

// BR chassis
#define MAX_BR_CHASSIS_OVERALL_U 13000
#define CENTER_ENCODER_ANGLE_PITCH (IS_BR1 ? 720 : 8161/*1453*/)*RAD_ENCODER_ANGLE_RATIO

// sentry chassis
#define MAX_TRACK_LENGTH 1.5	// in meters (track is actually 2.130m long, but we also need to consider the length of sentry's chassis)
#define MAX_SENTRY_CHASSIS_WHEELS_CONTROL_SIGNAL_AMPLITUDE 30000
...
#define M3508_gearbox_ratio (IS_SENTRY) ? 0.1 : 0.052075		// 0.052075 = (187/3591) = (from_rad_motor_to_rad_wheel)
...
#define CHASSIS_YAW_ENCODER_ZERO_OFFSET ((IS_STD) ? 5689 : ((IS_SENTRY) ? 0 : ((IS_BR1) ? 4392 : 4350))) * RAD_ENCODER_ANGLE_RATIO



// control/filtering options
#define MANTAIN_POSITION_GIMBAL_GAIN 0
...
#define SYSID_ACQUIRE_SAMPLES_PERIOD 	5e-3	// data sampling period
#define SYSID_SENT_NUM_SAMPLES 				200		// number of data to be sent to motors
#define SYSID_ACQUIRED_NUM_SAMPLES 		8000	// number of data to be sampled
