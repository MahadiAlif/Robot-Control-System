...
#define Q quaternion.element
    ...
    FusionEuler euler;
    euler.angle.pitch = FusionRadiansToDegrees(atan2f(Q.w * Q.x + Q.y * Q.z, halfMinusQySquared - Q.x * Q.x));
    euler.angle.roll = FusionRadiansToDegrees(asinf(2.0f * (Q.w * Q.y - Q.z * Q.x)));
